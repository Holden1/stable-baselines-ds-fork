...
class PPO2(ActorCriticRLModel):
    ...
    def set_learning_rate_func(self,learning_rate_func):
        self.learning_rate=learning_rate_func
    ...
    def learn(self, total_timesteps, callback=None, log_interval=1, tb_log_name="PPO2",
        ...
        with SetVerbosity(self.verbose), TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name, new_tb_log) \
            ...
            for update in range(1, n_updates + 1):
                ...
                lr_now = self.learning_rate(frac,update)
                ...
                if update % save_interval ==0:
                    print("Saving because of save interval")
                    self.save("D:/openAi/ppo2save/" + time.strftime("%Y_%m_%d-%H_%M_%S"))
...
class Runner(AbstractEnvRunner):
    ...
    def _run(self):
        ...
        ep_infos = []
        steps_so_far=0
        while(steps_so_far<self.n_steps or not self.dones[0]):
            if(self.dones[0]):
                self.env.reset()
        ...
        last_gae_lam = 0
        #print("Steps start: ",steps_so_far-self.n_steps,"steps so far: ",steps_so_far)
        #for step in reversed(range(steps_so_far-self.n_steps,steps_so_far)):
        for step in reversed(range(steps_so_far)):
            if step == steps_so_far - 1:
